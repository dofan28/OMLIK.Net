    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0 shadow rounded">
                <div class="card-body">
                    <p class="h4 text-center">Tambahkan Data</p>
                    <form action="{{ route('pembayaran.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                name="nama" value="{{ old('nama') }}" placeholder="Masukan nama pelanggan">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tahun') is-invalid @enderror"
                                name="tahun" value="{{ old('tahun') }}" placeholder="Masukan tahun pembayaran">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nominal') is-invalid @enderror"
                                name="nominal" value="{{ old('nominal') }}" placeholder="Masukan nominal pembayaran">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tgl_bayar') is-invalid @enderror"
                                name="tgl_bayar" value="{{ old('tgl_bayar') }}"
                                placeholder="Masukan Tanggal Bayar Pelanggan">
